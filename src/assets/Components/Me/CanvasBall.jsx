...
const CanvasBall = () => {
  ...
  return (
    <div className="skills-charts relative w-[50%]">
      <div id="myCanvasContainer" >
        <canvas width="700" height="700" id="myCanvas" className='w-[380px] md:w-[500px] lg-[700px]' ref={canva}>
          <ul id="tags">
            <li> <a href="https://en.wikipedia.org/wiki/HTML" target="_blank">HTML</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Cascading_Style_Sheets"
              target="_blank">CSS</a></li>
            <li><a href="https://en.wikipedia.org/wiki/JavaScript" target="_blank">ES5/ES6</a>
            </li>
            <li><a href="https://en.wikipedia.org/wiki/JavaScript"
              target="_blank">TypeScript</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Representational_state_transfer"
            ...
            <li><a href="https://en.wikipedia.org/wiki/Data_science" target="_blank">Data
              Science</a></li>
            <li><a href="https://en.wikipedia.org/wiki/WordPress" target="_blank">Wordpress</a>
            </li>
            <li><a href="https://en.wikipedia.org/wiki/PHP" target="_blank">PHP</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Python_(programming_language)"
              target="_blank">Python</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Node.js" target="_blank">Node JS</a>
            </li>
            ...
            <li><a href="https://en.wikipedia.org/wiki/Sass_(stylesheet_language)"
            ...
            <li><a href="http://mongoosejs.com/" target="_blank">SQl</a></li>
            ...
            <li><a href="https://en.wikipedia.org/wiki/BEM" target="_blank">Hugo</a></li>
          </ul>
        </canvas>
      </div>
    </div>
