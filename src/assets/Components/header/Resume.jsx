...
const Resume = () => {
    ...
    return (
        <div className="resumeBox-container absolute bottom-10 right-[30%] lg:bottom-[40%] opacity-0 " ref={te}>
            <div className="resumeBox h-[50px] w-[50px] md:h-[800px] md:w-[800px] absolute -left-20 bottom-10 md:bottom-0 md:-left-28 rotate-45"></div>
            <div className="resumeBox h-[150px] w-[150px] md:h-[180px] md:w-[180px] flex items-center justify-center   my-10 ">
